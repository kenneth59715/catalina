...
DEF_DEFAULT_MACHINE_NAME=unknown
...
${ECHO} "s@___TOPOLOGY_XDIM_PLACEHOLDER___@${CATALINA_TOPOLOGY_XDIM-None}@g" >> sedscr
${ECHO} "s@___TOPOLOGY_YDIM_PLACEHOLDER___@${CATALINA_TOPOLOGY_YDIM-None}@g" >> sedscr
${ECHO} "s@___TOPOLOGY_ZDIM_PLACEHOLDER___@${CATALINA_TOPOLOGY_ZDIM-None}@g" >> sedscr
